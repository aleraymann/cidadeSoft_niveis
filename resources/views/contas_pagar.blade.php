    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="form-row col-lg-12">
                <div>
                    <a href="{{ url("/Cadastro/ctas_pagar") }}" class="btn btn-sm btn-info mt-3 mr-2">Todos</a>
                </div>
                ...
                <div id="name" hidden>
                    <form action="{{ url('/Contas_Pagar/busca') }}" method="post">
                        <div class=" container">
                ...
                <div id="cod" hidden>
                    <form action="{{ url('/Contas_Pagar/busca2') }}" method="post">
                        <div class="container">
