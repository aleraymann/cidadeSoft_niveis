...
<div class="modal-body">
  ...
  <form method="post" class="needs-validation" novalidate action="{{url("/Transportadora/destino/salvar")}}">
   @else
   <form method="post" action="{{url("Transportadora/destino/salvar/$id")}}" enctype="multipart/form-data">
    @endif
    <div class="form-row">
      <div class="form-group col-lg-1" hidden>
        ...
        value="{{isset($transportadora_destino->Cod_Transp) ? $transportadora_destino->Cod_Transp : '' }}">
      </div>
      <div class="form-group col-lg-3">
        ...
        value="{{isset($transportadora_destino->Destino_Cidade) ? $transportadora_destino->Destino_Cidade : '' }}">
      ...
      <div class="form-group col-lg-2">
        ...
        <select class="form-control input-border-bottom" id="Destino_UF" name="Destino_UF" required>
          <option value="{{isset($transportadora_destino->Destino_UF) ? $transportadora_destino->Destino_UF : '' }} ">{{ $transportadora_destino->Destino_UF}}</option>
      ...
      <div class="form-group col-lg-2">
        ...
        minlength="1" required value="{{isset($transportadora_destino->Indice) ? $transportadora_destino->Indice : '' }}">
        <div class="invalid-feedback">
          Por favor, Campo Obrigatório!
        </div>
        <div class="valid-feedback">
