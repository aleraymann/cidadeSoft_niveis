...
<h2 class="ml-2">Edição de Valor</h2>
<!-- Modal body -->
<div class="modal-body">
  @if(!isset($id))
  <form method="post" class="needs-validation" novalidate action="{{url("/Transportadora/valor/salvar")}}">
   @else
   <form method="post" action="{{url("Transportadora/valor/salvar/$id")}}" enctype="multipart/form-data">
    @endif
    <div class="form-row">
      ...
      <div class="form-group col-lg-3">
        ...
        required value="{{isset($transportadora_valor->KmIni) ? $transportadora_valor->KmIni : '' }}">
      ...
      <div class="form-group col-lg-3">
        ...
        required value="{{isset($transportadora_valor->KmFim) ? $transportadora_valor->KmFim : '' }}">
        <div class="invalid-feedback">
          Por Favor, Campo Obrigatório!
        </div>
        <div class="valid-feedback">
      ...
      <div class="form-group col-lg-2">
        ...
        <input type="text" class="form-control input-border-bottom" name="Indice_v" id="Indice_v" maxlength="3"
        minlength="1" required value="{{isset($transportadora_valor->Indice_v) ? $transportadora_valor->Indice_v : '' }}">
        <div class="invalid-feedback">
          Por favor, Campo Obrigatório!
        </div>
        <div class="valid-feedback">
