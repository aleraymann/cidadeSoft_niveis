    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="form-row col-lg-12">
                <div>
                    <a href="{{ url("/Cadastro/cond_pag") }}" class="btn btn-sm btn-info mt-3 mr-2">Todos</a>
                </div>
                <div class="form-group col-lg-2">
                    <select onchange="verificar(this.value)" class="form-control input-border-bottom" id="filtro"
                        ...
                        <option value="D">Condição</option>
                    </select>
                </div>
                <div id="name" hidden>
                    <form action="{{ url('/Condicao/busca') }}" method="post">
                        <div class=" container">
                            <div class="input-group col-lg-10 mt-2">
                                <input type="text" class="form-control" name="criterio" placeholder="Condição">
                ...
                <div id="cod" hidden>
                    <form action="{{ url('/Condicao/busca2') }}" method="post">
                        <div class="container">
