    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="form-row col-lg-12">
                <div>
                    <a href="{{ url("/Cadastro/os_ped") }}" class="btn btn-sm btn-info mt-3 mr-2">Todos</a>
                </div>
                ...
                <div id="name" hidden>
                    <form action="{{ url('/CatOSPed/busca') }}" method="post">
                        <div class=" container">
                ...
                <div id="cod" hidden>
                    <form action="{{ url('/CatOSPed/busca2') }}" method="post">
                        <div class="container">
