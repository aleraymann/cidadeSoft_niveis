...
<div class="d-sm-flex align-items-center justify-content-between mb-4 ml-2"></div>
    <div class="col-md-12">
        ...
        <th class="">Aliquota I. Importado</th>
        <th class="">Aliquota I. Estadual</th>
        <th class="">Aliquota I. Municipal</th>
        <th class="">Ex</th>
        <th class="">Tipo</th>
    ...
    <tr>
        ...
        <td class=""> 
            <div class="btn-group" role="group">
                <a href='{{url("/Ncm/editar/$n->Codigo")}}' class="btn btn-success"><i class='far fa-edit'></i></a>
