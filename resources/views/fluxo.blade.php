    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="form-row col-sm-12">
                <div>
                    <a href="{{ url("/Cadastro/fluxo") }}" class="btn btn-sm btn-info mt-3 mr-2">Todos</a>
                </div>
                <div class="form-group col-lg-2">
                    <select onchange="verificar(this.value)" class="form-control input-border-bottom" id="filtro"
                        ...
                        <option value="P">Cod da Conta</option>
                    </select>
                </div>
                <div id="name" hidden>
                    <form action="{{ url('/Fluxo/busca') }}" method="post">
                        <div class=" container">
                ...
                <div id="cod" hidden>
                    <form action="{{ url('/Fluxo/busca2') }}" method="post">
                        <div class="container">
                ...
                <div id="pag_rec" hidden>
                    <form action="{{ url('/Fluxo/busca3') }}" method="post">
                        <div class="container">
                            <div class="input-group col-lg-12 mt-2 mr-2" >
                            <input type="text" class="form-control" name="criterio" placeholder="Código da Conta">
                        ...
                        @foreach($fluxo as $f)
                            @can('view_fluxo', $f)
                                <tr>
                                    ...
                                    <td class="">{{ date('d-m-Y', strtotime($f->Data)) }} </td>
                                    <td class="">{{ $f->Saldo }}  </td>
