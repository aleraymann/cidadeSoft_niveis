    ...
    <div class="wrapper wrapper-login">
        <div class="container container-login animated fadeIn">
            ...
            <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group form-floating-label col-12">
                            <div>
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} input-border-bottom" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group form-floating-label col-12">
                            <div>
                                <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }} input-border-bottom" name="password" required>
