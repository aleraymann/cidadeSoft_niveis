    ...
    <div class="modal-dialog  modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if(!isset($id))
                <form method="post" class="needs-validation" novalidate action="{{url("/CatOSPed/salvar")}}">
                 @else
                 <form method="post" action="{{url("/CatOSPed/salvar/$id")}}" enctype="multipart/form-data">
                    @endif
                    <div class="form-row">
