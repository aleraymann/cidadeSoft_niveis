           ...
           <form method="post" action="{{url("/Boleto_remessa/salvar/$id")}}" enctype="multipart/form-data">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-lg-3">
                ...
                <input type="text" class="form-control input-border-bottom" name="Data" id="Data"  value="{{ date('d/m/Y') }}"  required readonly>
              ...
              <div class="form-group col-lg-3">
                ...
                <input type="text" class="form-control input-border-bottom" name="Hora" id="Hora"  value="{{ date(' H:i:s') }}" readonly required >
                <div class="invalid-feedback">
                  Por favor, Campo Obrigatório!
                </div>
                <div class="valid-feedback">
              ...
              <div class="form-group col-lg-3">
                ...
                <input type="text" class="form-control input-border-bottom" name="Cod_Conv" id="Cod_Conv" value="0" required>
                <div class="invalid-feedback">
                    Por favor, Campo Obrigatório!
                  </div>
                  <div class="valid-feedback">
