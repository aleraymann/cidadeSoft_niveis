...
<div class="container">
<a class="btn btn-info" href='{{ url("/pdf_clifor") }}' target="blank">
...
<div class="col-md-12">
  ...
  @include("modals.modal_clifor")
                        ...
                        <tr>
                          ...
                          <td>  {{ $cf->Ativo==1? "Ativo":"Inativo"}}  </td>
                          ...
                          <td> 
                            <div class="btn-group" role="group">
                              <a href='{{url("/Clifor/editar/$cf->Codigo")}}' class="btn btn-success "><i class='far fa-edit'></i></a>
                              <a href='{{url("/Clifor/vizualizar/$cf->Codigo")}}' class="btn btn-secondary"><i class='far fa-eye'></i></a>
