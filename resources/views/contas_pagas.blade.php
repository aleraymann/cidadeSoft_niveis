    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="form-row col-sm-12">
                ...
                <div id="name" hidden>
                    <form action="{{ url('/Contas_Pagas/busca') }}" method="post">
                        <div class=" container">
                ...
                <div id="cod" hidden>
                    <form action="{{ url('/Contas_Pagas/busca2') }}" method="post">
                        <div class="container">
