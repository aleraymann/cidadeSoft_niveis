    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="form-row col-sm-12">
                <div>
                    <a href="{{ url("/Cadastro/movimento") }}" class="btn btn-sm btn-info mt-3 mr-2">Todos</a>
                </div>
                <div class="form-group col-lg-2">
                    <select onchange="verificar(this.value)" class="form-control input-border-bottom" id="filtro"
                        ...
                        <option value="P">Turno</option>
                    </select>
                </div>
                <div id="name" hidden>
                    <form action="{{ url('/DataMovimento/busca') }}" method="post">
                        <div class=" container">
                ...
                <div id="cod" hidden>
                    <form action="{{ url('/DataMovimento/busca2') }}" method="post">
                        <div class="container">
                ...
                <div id="pag_rec" hidden>
                    <form action="{{ url('/DataMovimento/busca3') }}" method="post">
                        <div class="container">
                        ...
                        @foreach($data_movimento as $m)
                           @can('view_data_movimento', $m)
                                <tr>
                                    ...
                                    <td class="">{{ date('d-m-Y', strtotime($m->Data)) }}</td>
